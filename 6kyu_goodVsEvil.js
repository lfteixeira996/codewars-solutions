...
// Hobbits: 1 Men: 2 Elves: 3 Dwarves: 3 Eagles: 4 Wizards: 10 On the side of
// evil we have:

// Orcs: 1 Men: 2 Wargs: 2 Goblins: 2 Uruk Hai: 3 Trolls: 5 Wizards: 10 Although
// weather, location, supplies and valor play a part in any battle, if you add
// up the worth of the side of good and compare it with the worth of the side of
...
// Hobbits, Men, Elves, Dwarves, Eagles, Wizards. The second parameter will
// contain the count of each race on the side of evil in the following order:

// Orcs, Men, Wargs, Goblins, Uruk Hai, Trolls, Wizards. All values are
// non-negative integers. The resulting sum of the worth for each side will not
